...
#include "digipots_ds3502.h"

/////////// SETUP FOR DIGIPOTS //////////////////////////////////

// Adafruit_DS3502 digipot_coarse = Adafruit_DS3502();
// Adafruit_DS3502 digipot_fine = Adafruit_DS3502();

Digipots_DS3502 digipots = Digipots_DS3502();
...
void executeCommand(String command, String args) {
  // Read Commands
  if (command.equals("") || command.equals("read_pwm")) {
    readChannels(0);
    return;
    // return 0;
  }
  ...
  // Write commands
  if (command.equals("pwm")) {
    units = 0;
    writeChannels(args);
    return;
    // return 0;
  }
  if (command.equals("pwm_mA")) {
    units = 1;
    writeChannels(args);
    return;
    // return 0;
  }
  if (command.equals("pwm_f")) {
    units = 2;
    writeChannels(args);
    return;
    // return 0;
...
int executeCommand_rint(String command, String args) {
  // Read Commands
  if (command.equals("") || command.equals("read_pwm")) {
    readChannels(0);
    // return;
